...
#  con tutte le canzoni del dataset songs.csv e restituisce le top k-canzoni campionate in modo probabilistico
...
#    - typing per specificare che tipo di dati le funzioni ricevono
#    - numpy per calcoli numerici come softmax, distanza vettoriale, campionamento casuale
#    - pandas per leggere e manipolare dataset songs.csv
